    ...
    if (_exp?.hasMatch(newValue.text) ?? false) {
      ...
      if (value.length >= 5) {
        ...
        if (value.substring(0, 4) == '00:0') {
          ...
          print(value.substring(leftChunk.length + 1, value.length));
          // } else if (value.substring(0,3) == '00:') {//6
          //   leftChunk = '0';
          //   rightChunk = ;
          // }
